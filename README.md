...
## Dataset
The dataset contains customer information including churn status, tenure, total charges, and city of residence. You can find the dataset in the `/notebooks` folder or [[download it here](https://drive.google.com/file/d/1USXIWFIaDMng66CKFDjdMZemJlP4C9LD/view?usp=drive_link))](#).
